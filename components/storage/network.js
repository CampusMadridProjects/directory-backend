...
exports.updateData = function (object) {
	...
	const localFilename = '/tmp/' + object.name;
	...
	return file.download({
		...
		.then((data) => {
			...
			// console.log('File "' + object.name + '" read successfully! Saved in "' + localFilename + '". Reading local file...')
			return require(localFilename);
		})
		.then((fileData) => {
			// console.log('Local file read! Executing actions...')
			return Controller.fileReaded(fileData, object.name)
		})
		.then((data) => {
